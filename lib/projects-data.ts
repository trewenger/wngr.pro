...
export const projects: Project[] = [
  {
    ...
    longDescription: `A production-ready portfolio website built from scratch with Next.js 14, TypeScript, and TailwindCSS, designed to showcase professional work and technical skills.

Key Features:
• Modern Tech Stack - Built with Next.js 14 App Router, TypeScript, and TailwindCSS for optimal performance and developer experience
...
• Working Contact Form - Fully functional contact form with server-side validation and email delivery via Nodemailer + Gmail SMTP
...
• Production Ready - Optimized build process and deployment pipeline for Netlify
